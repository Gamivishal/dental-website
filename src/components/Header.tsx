    ...
    <header className="sticky-header">
      <div className="header-container">
        ...
        <div className="header-logo" onClick={() => handleNav('home')}>
          <img src={logoImg} alt="Dr. Sheekha Shah Logo" className="logo-img" loading="lazy" />
          <div className="logo-text-branding">
        ...
        <div className="header-ctas">
          <a href="tel:9835333333" className="cta-icon-link phone-call" aria-label="Call Our Clinic">
            📞
            <span className="header-tooltip">Call Our Clinic</span>
          </a>
          <a
          ...
          <button className="header-book-appointment-btn" onClick={() => handleNav('enquiry')}>
            ...
            <span className="book-btn-text">
              <span className="line-1">BOOK</span>
              <span className="line-2">APPOINTMENT</span>
            </span>
          </button>
        </div>
